...
public class MakeBlackKingSideCastlingMoveTest {
	...
	public void makeAndUndo() {
		...
		assertThat(game.piece(h8), is(nullValue()));
		assertThat(game.piece(g8).type(), is(BlackKing));
		assertThat(game.piece(f8).type(), is(BlackRook));
		...
		assertThat(game.piece(f8), is(nullValue()));
		assertThat(game.piece(g8), is(nullValue()));
		assertThat(game.piece(e8).type(), is(BlackKing));
		assertThat(game.piece(h8).type(), is(BlackRook));
		assertThat(game.enPassant(), is(removed));
	}
